...
try:
    ...
    print(f"ERROR: Failed to import ADK components: {e}")
    print("Please ensure google-adk is properly installed: pip install google-adk")
    raise
...
# Initialize session service (required by ADK)
    ...
    try:
        ...
        async def run_agent_async():
            ...
            try:
                ...
                # Create proper InvocationContext with all required fields
                ...
                async for event in root_agent.run_async(context):
                    ...
                    if hasattr(event, 'text'):
                        ...
                        # Try string conversion, filter system messages
                        event_str = str(event)
                        if not event_str.startswith('<') and event_str.strip():
